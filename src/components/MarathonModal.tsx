        ...
        <Stack>
          ...
          <Select
            ...
            onChange={(value) => {
              ...
              discountCupon(value as "funrun" | "mini" | "half" | "full",couponCode,haveCoupon);
            }}
          ...
          onChange={
            (e)=>{
              ...
              discountCupon(plan,couponCode,e.currentTarget.checked)
            }
          }
          checked={haveCoupon}
          />
          ...
          discountCupon(plan,e.currentTarget.value, haveCoupon)
